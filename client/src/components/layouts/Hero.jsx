...
const Hero = () => {
   return (
      <div className="h-screen relative pt-[50px] flex items-center justify-center flex-col">
         ...
         <a href="#service" className="mt-[50px] cursor-pointer text-center z-50 border-2 border-[#5a8488] hover:bg-green-400 w-[250px] text-white rounded-2xl py-[17px] bg-[#000913]  text-2xl font-bold">
            Get Started
         </a>
      </div>
   );
