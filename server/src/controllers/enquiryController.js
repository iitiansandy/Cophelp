...
const addContactUsDetails = async (req, res) => {
  try {
    ...
    let { name, email, mobile, subject, text } = data;
    ...
    let msg =
      ...
      " </p>";
    var mailOptions = {
      from: `TCopHelp.com <${data.email}>`, // sender address
      to: 'service@turtltech.com', // list of receivers
      subject: data.subject, // Subject line
      mobile: data.mobile, // plaintext body
      html: msg,
    };
